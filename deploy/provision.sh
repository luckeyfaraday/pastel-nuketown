...
ACCOUNT_ENV_NAMES=(
  ...
  STRIPE_PRICE_PASTELS_500 STRIPE_PRICE_PASTELS_1100 STRIPE_PRICE_PASTELS_2500
...
STRIPE_PRICE_PASTELS_500="${STRIPE_PRICE_PASTELS_500:-}"
STRIPE_PRICE_PASTELS_1100="${STRIPE_PRICE_PASTELS_1100:-}"
STRIPE_PRICE_PASTELS_2500="${STRIPE_PRICE_PASTELS_2500:-}"
