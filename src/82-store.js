...
/* =====================================================================
   ...
   Which of these are visible at all is the media query's business in
   00-head.html; this file only decides whether there is anything to
   show. The one exception is the character, below, which is expensive
...
/* Tall, because it is a person standing up. Drawn at twice the size it is
   shown at so it survives a high-density screen. */
const MENU_HUD_HERO = { w: 340, h: 520 };
const MENU_HUD_WIDE = '(min-width:1040px) and (min-height:660px)';
